...
(function() {
  ...
  Sankey = (function() {
    function Sankey(elemName) {
      this.display_in_element = elemName;
    ...
    Sankey.prototype.stack = function(x, box_names, y_space, y_box) {
    ...
    Sankey.prototype.position_boxes_and_lines = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        stack = _ref[_i];
        x = stack.x;
        y = stack.y_box != null ? stack.y_box : 10;
