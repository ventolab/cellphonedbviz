...
function e(e, t, n) {
    ...
    "function" == typeof o ? (o = new o(t, { detail: n })) : ((o = r.createEvent("Event")).initEvent(t, !1, !1), (o.detail = n)), e.dispatchEvent(o);
}
function t(e) {
    return (
        Array.isArray(e) ||
...
const { getPrototypeOf: b, getOwnPropertyDescriptors: w } = Object,
    y = b({});
// datasome: commented out to hide plot parameters - observablehq displays them by default
// function v(n, o, a, i) {
//    let s,
//        c,
//        l,
...
//        : (u = h(n))
//        ? ((s = `Immutable.${u.name}${"Record" === u.name ? "" : `(${n.size})`}`), (f = u.arrayish), (c = u.arrayish ? N : u.setish ? E : A))
//        : i
//        ? ((s = d(n)), (c = x))
//        : ((s = d(n)), (c = T));
...
//            : (l = h(e))
//            ? ((i = `Immutable.${l.name}${"Record" === l.name ? "" : `(${e.size})`}`), (u = l.arrayish), (s = l.arrayish ? P : l.setish ? I : D))
//            : ((i = d(e)), (s = U)),
//        n)
//    ) {
//        const t = document.createElement("span");
...
function W(e, t) {
    ...
    return `${((i = e.getUTCFullYear()), i < 0 ? `-${H(-i, 6)}` : i > 9999 ? `+${H(i, 6)}` : H(i, 4))}-${H(e.getUTCMonth() + 1, 2)}-${H(e.getUTCDate(), 2)}${
...
//                    ? re(n, "(" + r[1] + ")", t)
//                    : (r = /^(?:async\s*)?\(\s*(\w+(?:\s*,\s*\w+)*)?\s*\)/.exec(o)) || (r = /^(?:async\s*)?function(?:\s*\*)?(?:\s*\w+)?\s*\(\s*(\w+(?:\s*,\s*\w+)*)?\s*\)/.exec(o))
...
class Inspector {
    ...
    fulfilled(t, n) {
        ...
        if (
            ((!(function (e) {
                ...
                (t = ae(t, !1, r.firstChild && r.firstChild.classList && r.firstChild.classList.contains("observablehq--expanded"), n)).classList.add("observablehq--inspect"),
    ...
    rejected(t, n) {
        ...
        (a.className = "observablehq--inspect"), n && a.appendChild(r(n)), a.appendChild(document.createTextNode((t + "").replace(se, ""))), o.appendChild(a), e(o, "error", { error: t });
    }
}
...
function pe(e) {
    ...
    return isNaN(e)
        ...
        : ((t = e.getUTCFullYear()) < 0 ? "-" + de(-t, 6) : t > 9999 ? "+" + de(t, 6) : de(t, 4)) +
              ...
              "-" +
              de(e.getUTCDate(), 2) +
              (a ? "T" + de(n, 2) + ":" + de(r, 2) + ":" + de(o, 2) + "." + de(a, 3) + "Z" : o ? "T" + de(n, 2) + ":" + de(r, 2) + ":" + de(o, 2) + "Z" : r || n ? "T" + de(n, 2) + ":" + de(r, 2) + "Z" : "");
}
function me(e) {
    var t = new RegExp('["' + e + "\n\r]"),
        n = e.charCodeAt(0);
                ...
                (ut = (async function () {
                    const e = await import(`${lt}${Ve.resolve()}`),
                        t = await e.selectBundle({
                            mvp: { mainModule: `${lt}${Ve.resolve("dist/duckdb-mvp.wasm")}`, mainWorker: `${lt}${Ve.resolve("dist/duckdb-browser-mvp.worker.js")}` },
                            eh: { mainModule: `${lt}${Ve.resolve("dist/duckdb-eh.wasm")}`, mainWorker: `${lt}${Ve.resolve("dist/duckdb-browser-eh.worker.js")}` },
                        }),
    ...
    try {
        switch (n.mimeType) {
            ...
            case "text/tab-separated-values":
                return await a.insertCSVFromPath(n.name, { name: t, schema: "main", ...r }).catch(async (e) => {
...
const It = Object.assign(
    async (e, t, n, r) => {
        if (
            ...
            (o = e) && ("function" == typeof o.sql || ("function" == typeof o.queryTag && ("function" == typeof o.query || "function" == typeof o.queryStream))) && ("table" !== a || "function" == typeof o.describeColumns) && o !== It)
        )
            return Ft(
                e,
                (function (e, t) {
            ...
            return (function (e, t) {
                ...
                if (t.names) {
                    ...
                    o &&
                        ...
                        (e = e.map((e) => Object.fromEntries(Object.keys(e).map((t) => [n.get(t)?.name ?? t, e[t]]))));
                }
...
var xn = Object.freeze({
    ...
    element: function (e, t) {
        ...
        if (t) for (var i in t) (o = (r = i).indexOf(":")), (n = t[i]), o >= 0 && "xmlns" !== (r = i.slice(0, o)) && (i = i.slice(o + 1)), gn.hasOwnProperty(r) ? a.setAttributeNS(gn[r], i, n) : a.setAttribute(i, n);
        return a;
    },
    input: function (e) {
...
function jn(e, t) {
    ...
    return { [Symbol.iterator]: An, next: () => (n ? { done: !0 } : ((n = !0), { done: !1, value: e })), return: () => ((n = !0), t(e), { done: !0 }), throw: () => ({ done: (n = !0) }) };
}
function $n(e) {
    let t,
        n,
        ...
        function (e) {
            ...
            Object.defineProperties(
                ...
                ((n = {
                    ...
                    aapl: () =>
                        new FileAttachment("https://static.observableusercontent.com/files/3ccff97fd2d93da734e76829b2b066eafdaac6a1fafdec0faf6ebc443271cfc109d29e80dd217468fcb2aff1e6bffdc73f356cc48feb657f35378e6abbbb63b9").csv({
                            typed: !0,
                        }),
                    alphabet: () =>
                        new FileAttachment("https://static.observableusercontent.com/files/75d52e6c3130b1cae83cda89305e17b50f33e7420ef205587a135e8562bcfd22e483cf4fa2fb5df6dff66f9c5d19740be1cfaf47406286e2eb6574b49ffc685d").csv({
                            typed: !0,
                        }),
                    cars: () =>
                        new FileAttachment("https://static.observableusercontent.com/files/048ec3dfd528110c0665dfa363dd28bc516ffb7247231f3ab25005036717f5c4c232a5efc7bb74bc03037155cb72b1abe85a33d86eb9f1a336196030443be4f6").csv({
                            typed: !0,
                        }),
                    citywages: () =>
                        new FileAttachment("https://static.observableusercontent.com/files/39837ec5121fcc163131dbc2fe8c1a2e0b3423a5d1e96b5ce371e2ac2e20a290d78b71a4fb08b9fa6a0107776e17fb78af313b8ea70f4cc6648fad68ddf06f7a").csv({
                            typed: !0,
                        }),
                    diamonds: () =>
                        new FileAttachment("https://static.observableusercontent.com/files/87942b1f5d061a21fa4bb8f2162db44e3ef0f7391301f867ab5ba718b225a63091af20675f0bfe7f922db097b217b377135203a7eab34651e21a8d09f4e37252").csv({
                            typed: !0,
                        }),
                    flare: () =>
                        new FileAttachment("https://static.observableusercontent.com/files/a6b0d94a7f5828fd133765a934f4c9746d2010e2f342d335923991f31b14120de96b5cb4f160d509d8dc627f0107d7f5b5070d2516f01e4c862b5b4867533000").csv({
                            typed: !0,
                        }),
                    industries: () =>
                        new FileAttachment("https://static.observableusercontent.com/files/76f13741128340cc88798c0a0b7fa5a2df8370f57554000774ab8ee9ae785ffa2903010cad670d4939af3e9c17e5e18e7e05ed2b38b848ac2fc1a0066aa0005f").csv({
                            typed: !0,
                        }),
                    miserables: () =>
                        new FileAttachment("https://static.observableusercontent.com/files/31d904f6e21d42d4963ece9c8cc4fbd75efcbdc404bf511bc79906f0a1be68b5a01e935f65123670ed04e35ca8cae3c2b943f82bf8db49c5a67c85cbb58db052").json(),
                    olympians: () =>
                        new FileAttachment("https://static.observableusercontent.com/files/31ca24545a0603dce099d10ee89ee5ae72d29fa55e8fc7c9ffb5ded87ac83060d80f1d9e21f4ae8eb04c1e8940b7287d179fe8060d887fb1f055f430e210007c").csv({
                            typed: !0,
                        }),
                    penguins: () =>
                        new FileAttachment("https://static.observableusercontent.com/files/715db1223e067f00500780077febc6cebbdd90c151d3d78317c802732252052ab0e367039872ab9c77d6ef99e5f55a0724b35ddc898a1c99cb14c31a379af80a").csv({
                            typed: !0,
                        }),
                    weather: () =>
                        new FileAttachment("https://static.observableusercontent.com/files/693a46b22b33db0f042728700e0c73e836fa13d55446df89120682d55339c6db7cc9e574d3d73f24ecc9bc7eb9ac9a1e7e104a1ee52c00aab1e77eb102913c1f").csv({
                            typed: !0,
                        }),
                    DOM: xn,
                    Files: Tn,
...
function Module(e, t = []) {
    Object.defineProperties(this, { _runtime: { value: e }, _scope: { value: new Map() }, _builtins: { value: new Map([["@variable", nr], ["invalidation", rr], ["visibility", or], ...t]) }, _source: { value: null, writable: !0 } });
}
...
function pr(e, t) {
    let n,
        ...
        s = Yn;
    return (
        o && ((r = new IntersectionObserver(([e]) => (a = e.isIntersecting) && ((n = null), i()))), r.observe(o), e.then(() => (r.disconnect(), (r = null), s()))),
        function (e) {
...
function mr(e) {
    ...
    const t = e._value,
        n = ++e._version;
    let r = null;
    const o = (e._promise = (e._inputs.length
        ...
        if (
            ...
            return (
                ...
                (function (e, t, n) {
                    ...
                    let o;
                    function a(e) {
                        return new Promise((e) => e(n.next(o))).then(({ done: t, value: n }) => (t ? void 0 : Promise.resolve(n).then(e)));
                    }
                    function i() {
                        const n = a((a) => {
